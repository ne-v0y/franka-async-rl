...
from envs.visual_ur5_reacher.utils import *
...
from envs.visual_ur5_reacher.agents import *
...
class FrankaPanda_agile_grasping_V0(gym.Env):
    ...
    def __init__(self, config_file =None):
        ...
        config_file = os.path.join(os.path.dirname(__file__), os.pardir, 'visual_ur5_reacher/reacher.yaml')
    ...
    def reset(self):
        ...
        # command robot go to a random position
        # print('reset_starts')

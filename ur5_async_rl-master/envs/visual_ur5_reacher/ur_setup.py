...
setups = {
    'Franka': {
    'host': '172.16.0.1',  # put Franka Controller address here
                  'end_effector_low': np.array([-0.2, -0.3, 0.5]),  # for gripper?
                  ...
                  'speed_max': 0.1,   # maximum joint speed magnitude using speedj
                  'accel_max': 2,      # maximum acceleration magnitude of the leading axis using speedj
                  'reset_speed_limit': 0.5,
                  'q_ref': np.array([ 1.58724391, -2.4, 1.5, -0.71790582, 1.63685572, 1.00910473, 0]),
